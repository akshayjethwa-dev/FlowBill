                ...
                >
                  {activeSection === 'profile' && (
                    <BusinessProfileSection
                      ...
                      onChange={(profile) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'branding' && (
                    <BrandingSection
                      ...
                      onLogoChange={(url) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'gst' && (
                    <GstSettingsSection
                      ...
                      onChange={(gst) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'invoice' && (
                    <InvoiceSettingsSection
                      ...
                      onChange={(invoice) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'reminders' && (
                    <ReminderSettingsSection
                      ...
                      onChange={(reminders) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'payments' && (
                    <PaymentSettingsSection
                      ...
                      onChange={(payments) => setLocalSettings(prev => ({
                        ...prev,
                  ...
                  {activeSection === 'team' && (
                    <TeamSettingsSection
                      members={team}
                      onAddMember={() => console.log('Add member modal')}
                  ...
                  {activeSection === 'subscription' && (
                    <SubscriptionSection
                      ...
                      onUpgrade={(planId) => setLocalSettings(prev => ({ ...prev, subscriptionPlan: planId }))}
                    />
                  )}
                </motion.div>
              </AnimatePresence>
